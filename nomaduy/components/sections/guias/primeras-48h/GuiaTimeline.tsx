...
const phases = [
  {
    id: 'fase-1',
    badge: '✈️', badgeColor: 'blue',
    time: '🕐 Primeras 2 horas — Al aterrizar', timeColor: 'blue',
    title: 'En el aeropuerto',
    steps: [
      {
        num: 1, icon: '📱', title: 'Comprá una SIM card', subtitle: 'Antel o Claro — en el mismo aeropuerto',
      ...
      {
        num: 2, icon: '💵', title: 'Cambiá dinero', subtitle: 'Casa de cambio en Carrasco',
        priority: 'priority-now', priorityLabel: 'Ahora',
      ...
      {
        num: 3, icon: '🚗', title: 'Transporte al centro', subtitle: 'Taxi, Uber o bus',
        priority: 'priority-now', priorityLabel: 'Ahora',
  ...
  {
    id: 'fase-2',
    badge: '☀️', badgeColor: 'gold',
    time: '🕑 Primer día', timeColor: 'gold',
    title: 'Instalarate',
    steps: [
      {
        num: 4, icon: '💳', title: 'Descargá Prex', subtitle: 'Billetera digital uruguaya',
      ...
      {
        num: 5, icon: '📱', title: 'Instalá las apps esenciales', subtitle: 'Taxi, delivery, mapas',
        priority: 'priority-soon', priorityLabel: 'Día 1',
      ...
      {
        num: 6, icon: '🏘', title: 'Orientate en tu barrio', subtitle: 'Supermercado, farmacia, cajero',
        priority: 'priority-soon', priorityLabel: 'Día 1',
  ...
  },
  {
    ...
    time: '☀️ Día 2 — Primeros trámites', timeColor: 'green',
    title: 'Primeros pasos burocráticos',
    steps: [
      {
        num: 7, icon: '🪪', title: 'Cédula de identidad', subtitle: 'Correo Uruguayo o DNIC',
      ...
      {
        num: 8, icon: '🏥', title: 'Mutualista o DISSE', subtitle: 'Sistema de salud',
        priority: 'priority-day2', priorityLabel: 'Día 2+',
      ...
      {
        num: 9, icon: '🌐', title: 'Unirte a NomadUY', subtitle: 'La comunidad que hace más fácil todo esto',
        priority: 'priority-day2', priorityLabel: 'Día 2+',
          ...
          {phases.map((phase) => (
            <section key={phase.id} id={phase.id} className="timeline-section">
              <div className="phase-header">
                <div className={`phase-badge ${phase.badgeColor}`}>{phase.badge}</div>
