  ...
  return (
    <section className="community-banner" id="community">
      <AnimateIn className="community-left" direction="left">
        ...
        <div className="community-channels">
          <a href="#" className="channel-pill">
            <span className="channel-icon wa-icon"><WhatsAppIcon /></span>
          ...
          <a href="#" className="channel-pill">
            <span className="channel-icon tg-icon"><TelegramIcon /></span>
            Canal de Telegram
          </a>
          <a href="#" className="channel-pill">
            <span className="channel-icon ig-icon"><InstagramIcon /></span>
            Instagram
          </a>
        </div>
      ...
      <AnimateIn className="community-form community-form-simple" direction="right" delay={0.1}>
        <div className="community-form-eyebrow">Empezá hoy</div>
        <h3>Tu guía de bienvenida,<br />gratis en tu inbox.</h3>
        <p>Dejá tu email y en 2 minutos recibís &ldquo;Tus primeros 30 días en Uruguay&rdquo; + acceso a los grupos de WhatsApp.</p>
        ...
        <button className="submit-btn">Quiero unirme →</button>
