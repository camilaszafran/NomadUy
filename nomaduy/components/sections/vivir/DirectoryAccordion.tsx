...
const coworkings = [
  ...
  { name: 'WorkInn', barrio: 'punta-carretas', price: '$20/día', mbps: 400, rating: 4.6, bars: 5, badge: '⭐ Premium', badgeStyle: { background: '#FEF4E4', color: 'var(--gold)' }, tags: ['Salas privadas', 'Recepción', 'AC'] },
...
const sections = [
  { id: 'coworkings', icon: '💻', title: 'Coworkings', subtitle: 'Espacios verificados con WiFi testeado y precios reales', countLabel: '6 espacios', countClass: 'green' },
  { id: 'coliving', icon: '🏠', title: 'Coliving & Alojamiento', subtitle: 'Cuartos amoblados, departamentos para nómadas y coliving', countLabel: 'Próximamente', countClass: 'soon', comingSoon: 'Estamos verificando y listando los mejores espacios de coliving y alquiler para nómadas en Montevideo y más.' },
  { id: 'medicos', icon: '🏥', title: 'Médicos recomendados', subtitle: 'Profesionales que hablan inglés y atienden a extranjeros', countLabel: 'Próximamente', countClass: 'soon', comingSoon: 'Médicos generalistas, dentistas y especialistas recomendados por la comunidad NomadUY.' },
  { id: 'servicios', icon: '🛠', title: 'Servicios de confianza', subtitle: 'Contadores, escribanos, traductores y más', countLabel: 'Próximamente', countClass: 'soon', comingSoon: 'Profesionales de confianza para trámites, impuestos y servicios cotidianos.' },
  { id: 'restaurantes', icon: '🍽', title: 'Restaurantes', subtitle: 'Los favoritos de la comunidad — no los del turista', countLabel: 'Comunidad', countClass: 'gold', comingSoon: 'Las recomendaciones vienen de miembros reales de NomadUY — no de guías de viaje.', notifyLabel: '➕ Sugerir un restaurante' },
  { id: 'cafes', icon: '☕', title: 'Cafés para trabajar', subtitle: 'Buen WiFi, enchufes y café decente', countLabel: 'Comunidad', countClass: 'gold', comingSoon: 'Los mejores cafés para trabajar en Montevideo — testeados por nómadas reales.', notifyLabel: '➕ Sugerir un café' },
]
                        ...
                        .map((c) => (
                          <div key={c.name} className="cowork-card">
                            <div className="cowork-header">
                              ...
                              <span className="cowork-badge" style={c.badgeStyle}>{c.badge}</span>
                            </div>
                            ...
                            <div className="cowork-stats">
                              ...
                              <span className="cowork-stat">⭐ {c.rating}</span>
                            </div>
